...
@Test(priority=2)
	...
	lp.loginpageMethod(prop.getProperty("adminname"),prop.getProperty("password"));
...
public void invalidloginTest() throws Exception{
	...
	lp.loginpageMethod(prop.getProperty("invalidusername"),prop.getProperty("invalidpassword"));
